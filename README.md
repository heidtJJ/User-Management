...
<ol type="1">
  ...
  <li>Create a mysql database called EE564. Feel free to change the name, but you must modify <a href="user-management/WEB-INF/classes/UserManager/UserManager.java">UserManager.java</a> </li>
</ol>  
