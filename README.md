...
<br><br><strong>Insert the following xml code snippet</strong> into context.xml located in the /conf folder under the apache-tomcat directory. <strong>Adjust the xml code based on the username, password, and table-name for the database that you created.</strong>
